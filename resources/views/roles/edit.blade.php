...
@section('title', 'Konfigurasi Peran & Izin: ' . $role->name)
...
<div class="max-w-5xl mx-auto" x-data="{
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-3">
            <h1 class="text-2xl font-black text-gray-800 tracking-tight">Konfigurasi Hak Akses: {{ $role->name }}</h1>
        ...
        <p class="text-gray-500 text-sm mt-0.5">Sesuaikan perizinan (*granular permissions*) untuk peran ini. Perubahan akan langsung berdampak pada seluruh pengguna yang mengemban peran ini.</p>
    </div>
    ...
    <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Identitas & Tampilan Peran</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-2">Slug Sistem (Readonly)</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="description" value="{{ old('description', $role->description) }}" placeholder="Deskripsi wewenang peran"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 pb-4 border-b border-gray-100">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">Konfigurasikan izin untuk peran ini. Centang izin yang ingin diberikan.</p>
                </div>
            ...
            <div class="mb-6 p-4 rounded-xl bg-purple-50 border border-purple-200 text-purple-800 text-xs leading-relaxed flex items-center">
                ...
                <span><strong>Catatan:</strong> Peran Super Admin secara otomatis memiliki hak bypass ke seluruh modul sistem tanpa kecuali. Izin di bawah ini tetap dicentang sebagai dokumentasi kapabilitas.</span>
            </div>
            @endif
