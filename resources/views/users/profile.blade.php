...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Manage your account information and password.</p>
    </div>
            ...
            <form action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 pt-4 border-t border-gray-100">
                        <p class="text-xs font-bold text-primary uppercase mb-4">Change Password (Leave blank if unchanged)</p>
                    </div>
