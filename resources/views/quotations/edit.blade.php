            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="issued" {{ old('status', $quotation->status) == 'issued' ? 'selected' : '' }}>ISSUED</option>
                ...
                <div class="col-span-1">
                    ...
                    <p class="mt-1 text-[10px] text-gray-400 uppercase font-bold tracking-widest">Required for quotation validity period.</p>
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="working_duration" id="working_duration" value="{{ old('working_duration', $quotation->working_duration) }}" required placeholder="e.g. 14 Working Days"
                ...
                <div class="col-span-2">
                    ...
                    <input type="file" name="attachment_pdf" id="attachment_pdf" accept="application/pdf"
                        class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary sm:text-sm p-3 border">
                    <p class="mt-1 text-[10px] text-gray-400">Upload a PDF file (Max 10MB) to replace the current attachment.</p>
                    @if($quotation->attachment_pdf)
                        <div class="mt-2 flex items-center p-3 bg-blue-50 rounded-lg border border-blue-100">
                            ...
                            <a href="{{ asset('storage/' . $quotation->attachment_pdf) }}" target="_blank" class="text-xs font-black text-blue-600 uppercase hover:underline">Current Attachment (View)</a>
                        </div>
                    @endif
