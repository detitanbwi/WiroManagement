...
<body>
    <div class="container">
            ...
            <tr>
                <td class="info-left">
                    <div class="client-box">
                        <div
                            style="font-size: 9px; font-weight: bold; color: #6b7280; text-transform: uppercase; margin-bottom: 4px;">
                            Kepada Yth:</div>
        ...
        <div class="footer">
            ...
            <div class="notes-box">
                @if($notes)
                    <p style="font-weight: bold; color: #374151; margin-bottom: 5px; text-decoration: underline;">Catatan
                        Penawaran:</p>
            ...
            <div class="terms-page">
                ...
                <div style="margin-top: 50px; border-top: 1px dashed #ccc; padding-top: 20px;">
                    <table style="width: 100%;">
                        <tr>
                            <td
                                style="width: 100%; font-size: 10px; color: #444; font-style: italic; text-align: center; line-height: 1.5;">
                                "Dengan melakukan pembayaran Down Payment (DP), Klien dinyatakan telah membaca, memahami,
                                dan menyetujui seluruh Syarat & Ketentuan yang berlaku di Wirodayan Digital tanpa
                                terkecuali."
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="text-align: right; font-size: 9px; color: #999; font-style: italic; padding-top: 15px;">
                                Halaman ini merupakan lampiran tidak terpisahkan dari Quotation
