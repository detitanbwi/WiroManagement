...
<div class="max-w-7xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Welcome, {{ auth()->user()->name ?? 'Admin' }}</h1>
        <p class="text-gray-500">Daily operational summary.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="p-6 rounded-xl shadow-md bg-gradient-to-br from-purple-600 to-fuchsia-500 text-white">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm font-medium text-purple-100">Active Projects</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-indigo-600 flex justify-between items-center bg-gradient-to-r from-indigo-600 to-blue-500 text-white">
                <h3 class="font-bold text-white shadow-sm">Recent Projects</h3>
                <a href="{{ route('projects.index') }}" class="text-xs font-bold text-indigo-50 hover:text-white bg-white/20 px-3 py-1.5 rounded-lg backdrop-blur-sm transition-colors">View All &rarr;</a>
            </div>
                ...
                <table class="min-w-full">
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                @can('projects.manage')
                                <a href="{{ route('projects.show', $p) }}" class="text-xs font-bold text-gray-400 hover:text-primary">VIEW</a>
                                @endcan
                            </td>
                        </tr>
                        @endforeach
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-600 flex justify-between items-center bg-gradient-to-r from-slate-600 to-gray-500 text-white">
                <h3 class="font-bold text-white shadow-sm">Unpaid Invoices</h3>
                <span class="text-xs font-bold text-slate-100 px-3 py-1.5">Billing Monitoring</span>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <tbody class="divide-y divide-gray-50">
